...
export const gallery = {
  ...
  categories: [
    ...
    },
    {
      name: "Travel Photos",
      items: [
        { src: "/travel-photos/adventure.webp", alt: "Adventure travel", label: "Adventure" },
        { src: "/travel-photos/japan-travel.webp", alt: "Japan travel", label: "Japan" },
        { src: "/travel-photos/new-zealand.webp", alt: "New Zealand trip", label: "New Zealand" },
        { src: "/travel-photos/palawan.webp", alt: "Palawan, Philippines", label: "Palawan" },
        { src: "/travel-photos/scuba-diving-palawan.webp", alt: "Scuba diving in Palawan", label: "Scuba Palawan" },
        { src: "/travel-photos/scuba-diving-samal.webp", alt: "Scuba diving in Samal", label: "Scuba Samal" },
        { src: "/travel-photos/wheels-on-beach.webp", alt: "Wheelchair on the beach", label: "Beach" },
        { src: "/travel-photos/data-5.webp", alt: "Travel photo", label: "Travel" },
        { src: "/travel-photos/data-9.webp", alt: "Travel photo", label: "Travel" },
        { src: "/travel-photos/data-12.webp", alt: "Travel photo", label: "Travel" },
        { src: "/travel-photos/data-13.webp", alt: "Travel photo", label: "Travel" },
        { src: "/travel-photos/data-16.webp", alt: "Travel photo", label: "Travel" },
        { src: "/travel-photos/data-22.webp", alt: "Travel photo", label: "Travel" },
      ],
    },
    {
      name: "Events",
      items: [
        { src: "/events/aus-awards-alumni-grant.webp", alt: "Australia Awards Alumni Grant", label: "Aus Awards Alumni Grant" },
        { src: "/events/australia-awards-ceremony.webp", alt: "Australia Awards Ceremony", label: "Awards Ceremony" },
        { src: "/events/australia-awards-speaker.webp", alt: "Speaking at Australia Awards", label: "Awards Speaker" },
        { src: "/events/australia-awards.webp", alt: "Australia Awards", label: "Australia Awards" },
        { src: "/events/content-accessibility-campaign.webp", alt: "Content Accessibility Campaign", label: "Accessibility Campaign" },
        { src: "/events/data-7.webp", alt: "Data event photo", label: "Data Event" },
        { src: "/events/data-8.webp", alt: "Data event photo", label: "Data Event" },
        { src: "/events/data-11.webp", alt: "Data event photo", label: "Data Event" },
        { src: "/events/gedsi-hosting.webp", alt: "GEDSI event hosting", label: "GEDSI Hosting" },
        { src: "/events/gedsi-summit.webp", alt: "GEDSI Summit", label: "GEDSI Summit" },
        { src: "/events/google-training.webp", alt: "Google training", label: "Google Training" },
        { src: "/events/happiest-pinoy.webp", alt: "Happiest Pinoy", label: "Happiest Pinoy" },
        { src: "/events/rdc-national-convention.webp", alt: "RDC National Convention", label: "RDC Convention" },
        { src: "/events/rdc-xi-council-meeting.webp", alt: "RDC XI Council Meeting", label: "RDC XI Council" },
        { src: "/events/beijing-1.webp", alt: "Beijing trip", label: "Beijing" },
        { src: "/events/singapore-2.webp", alt: "Singapore trip", label: "Singapore" },
      ],
    },
  ] as GalleryCategory[],
};
